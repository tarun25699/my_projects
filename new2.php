...
<body>
	...
	<form method="post">
		...
		<label>RollNo1:</label><br>
		<input type="text" name="acceptedemail1" class="mailbox" placeholder=" Enter Your roll Number"><br>

		<label>Name:</label><br>
		<input type="text" name="name2" class="mailbox" placeholder=" Enter Your name"><br>
		<label>RollNo2:</label><br>
		<input type="text" name="acceptedemail2" class="mailbox" placeholder=" Enter Your roll Number"><br>

		<label>Tentative Title:</label><br>
		<input type="text" name="title2" class="mailbox" placeholder=" Enter Your title of project">

		<input type="text" name="duplicate" style="opacity: 0.9s; width:0px; height:0px;" value="<?php echo $id; ?>"><br>
		<a><button class="contact" name="accept" >accept</button></a>
